...
var TeacherRestController = function(TeacherModel) {
    ...
    var echoMsg = function(req, res) {
        res.status(200);
        res.send("echo REST GET returned input msg:" + req.params.msg); // 'res.send("echo REST GET returned input msg:%s", req.params.msg)' is WRONG. Syntax is 'res.send(status, body)'
    };
     ...
     * _id (the primary key that mongodb by default creates an index to speed up finds on) and __v (meaning version) will be added to record by mongodb itself
     * http://localhost:9016/teachers             POST
     * 
       curl -X POST -H "Content-Type: application/json" -i -d  '{"teacherId": 0, "name":"ilker_0", "lastname":"kiris_0", "title":"professor", "age":200, "isFullTime":true}' http://localhost:9016/teachers
       curl -X POST -H "Content-Type: application/json" -d     '{"teacherId": 1, "name":"ilker_1", "lastname":"kiris_1", "title":"assistant professor",  "age":201, "isFullTime":true}' http://localhost:9016/teachers
       curl -X POST -H "Content-Type: application/json" --data '{"teacherId": 2, "name":"ilker_2", "lastname":"kiris_2", "title":"associate professor", "age":202, "isFullTime":false}'  http://localhost:9016/teachers
       curl -X POST -H "Content-Type: application/json" -i -d  '{"teacherId": 3, "name":"ilker_3", "lastname":"kiris_3", "title":"professor emeritus", "age":203, "isFullTime":false}'  http://localhost:9016/teachers
     * 
     ...
     * 
       curl -X PUT -H "Content-Type: application/json" -i -d '{"teacherId": 0, "name":"ilker_0_update",   "lastname":"kiris_0", "title":"professor", "age":200, "isFullTime":false}' http://localhost:9016/teachers/5a23f72a1fb00a38f0a814a9
       curl -X PUT -H "Content-Type: application/json" -i -d '{"teacherId": 0, "name":"ilker_0_update_2", "lastname":"kiris_0", "title":"professor", "age":200, "isFullTime":false, "updatedOn":"2017-12-03T12:39:06.446Z"}' http://localhost:9016/teachers/5a23f72a1fb00a38f0a814a9
       curl -X PUT -H "Content-Type: application/json" -i -d '{"teacherId": 0, "name":"ilker_0_update_2", "lastname":"kiris_0", "title":"professor", "age":200, "isFullTime":false, "updatedOn":"'"$(date +%Y-%m-%dT%H:%M:%S)"'"}' http://localhost:9016/teachers/5a23f72a1fb00a38f0a814a9
       curl -X PUT -H "Content-Type: application/json" -i -d '{"teacherId": 3, "name":"ilker_3_update",   "lastname":"kiris_3", "title":"professor", "age":200, "isFullTime":false, "updatedOn":"'"$(date +%Y-%m-%dT%H:%M:%S)"'"}' http://localhost:9016/teachers/5a2f2505c96a552334fdc762
     * 
     * In postman, select PUT as method, click Body, click raw, select "JSON(application/json)" pulldown,
     * in url enter   http://localhost:9016/teacher/5a23e72b0a47f03f787cd618
    ...
    /**
     * Fulfills PATCH REST requests. this is allows partial update of teacher record. 
     * 1) Find the teacher from mongodb by id provided in the url
     ...
     * 
       curl -X PATCH -H "Content-Type: application/json" -i -d '{"title":"assistant professor", "age":123, "isFullTime":false}' http://localhost:9016/teachers/5a23f72a1fb00a38f0a814a9
     * 
     * @param {*} req 
     * @param {*} res 
     */
     ...
     * _id and _version will be added to record by mongodb itself
